...
`imports` enable the author of a blueprint to reuse blueprint files, or parts of them, and to use predefined types (e.g. from the [types.yaml]( http://www.getcloudify.org/spec/cloudify/4.5.5.dev1/types.yaml ) file).
...
# Namespace
You can import any resource and add a namespace context to all included Cloudify DSL elements.
...
The blueprint import format is `NAMESPACE->blueprint:BLUEPRINT_ID`, while specifying a namespace is a requirement. 
